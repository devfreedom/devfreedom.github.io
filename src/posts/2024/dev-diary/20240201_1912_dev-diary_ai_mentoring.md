...
# HuggingFace 기반으로 작성한 예시 코드

1. Dependency 준비
```
# Transformers를 사용하기 위한 dependency 입니다.
!pip install transformers
!pip install sentencepiece

# KoBERT를 사용하기 위한 dependency 입니다.
...
# 저장된 가장 최적의 체크포인트를 지정해줍니다. 예: checkpoint-400
...
- VM에서 배포를 하더라도 Flask 서버는 가급적 파이썬 가상환경을 사용해서 독립적으로 유지보수하세요.
